...
export const t600: MockProduct = {
  ...
  quickSpecs: [
    ...
    S("Net Weight", "整机重量", "标准版 112 kg / 潜伏版 94 kg"),
    S("Body Height", "机身高度", "潜伏版仅 255 mm"),
    S("Navigation", "导航方式", "标准版 VSLAM+激光SLAM / 潜伏版激光SLAM"),
  ],
  specGroups: [
    {
      group: L("General", "通用"),
      items: [
        S("Model", "产品型号", "标准版 WTIDL2 / 潜伏版 WTIDU2"),
        S("Net Weight", "整机重量", "标准版 112 kg / 潜伏版 94 kg"),
        S(
          "Dimensions (L×W×H)",
          "整机尺寸（L×W×H）",
        ...
        S("Display", "屏幕规格", "标准版 10.1 寸 LCD 屏；潜伏版无屏"),
    ...
    },
    {
      ...
      items: [
        S("Max Payload", "最大负载", "600 kg"),
        S("Travel Speed", "运行速度", "0.2 ~ 1.2 m/s（可调节）"),
        S("Runtime", "续航时间", "12 h（空载巡航）/ 6 h（最大负载）"),
        S("Max Obstacle Height", "最大越障高度", "10 mm（满载工况）"),
        S("Max Gap Width", "最大过缝宽度", "35 mm"),
        S("Min Passage Width", "最小通过宽度", "标准版 70 cm / 潜伏版 65 cm"),
    ...
    },
    {
      ...
      items: [
        ...
        S("Charging Method", "充电方式", "充电器、充电桩、快拆换电"),
        S(
    ...
    },
    {
      ...
      items: [
        S("Navigation", "导航方式", "标准版 VSLAM + 激光SLAM / 潜伏版激光SLAM"),
        S("RGBD Depth Camera", "RGBD深度相机", "向下RGBD + 向上RGBD"),
        S("Top Camera", "顶视相机", "标准版配置（VSLAM建图与天花板定位码识别）"),
        S("Front Camera", "前视相机", "标准版配置（人体轮廓识别）"),
    ...
    },
    {
      group: L("Safety", "安全"),
      items: [
        S("Emergency Stop Switch", "急停开关", "标准版多处配置"),
        S("Brake Switch", "制动器开关", "支持关机自锁驻停，防负载溜坡"),
        S("Power-Assist Switch", "助力开关", "标准版配置"),
      ],
    },
    {
      ...
      items: [
        ...
        S("Multi-Robot Scheduling", "多机调度", "支持多机协同调度"),
      ],
    },
    {
