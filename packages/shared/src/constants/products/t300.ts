  ...
  specGroups: [
    {
      group: L("General", "通用"),
      items: [
        S("Model", "产品型号", "标准版 WTID01 / 顶升版 WTIDL1", "Standard WTID01 / lifting WTIDL1"),
        S(
          "Net Weight",
          "整机重量",
          "标准版 65 kg / 顶升版 81 kg",
        ...
        S(
          "Body Material",
          "整机材质",
          "外壳 PC+ABS；立柱、底盘铝合金；负载面盖板铁",
          "PC+ABS housing; aluminum column & chassis; steel load cover",
        ),
    ...
    },
    {
      ...
      items: [
        ...
        S(
          ...
          "RGBD深度相机",
          "2 个（前部，上/下探测）",
          "2 (front, up/down sensing)",
        ),
        S(
          "LiDAR",
          "激光雷达",
          "2 个（底盘对角布置，360°覆盖，FDA Class 1）",
          "2 (diagonal chassis, 360° coverage, FDA Class 1)",
        ),
        S(
          "Top Camera",
          "顶视相机",
        ...
        S(
          ...
          "前视相机",
          "1 个（人体轮廓识别，支持跟随模式）",
          "1 (human-shape recognition, supports follow mode)",
        ),
        S(
          "Bumper Switch",
          "碰撞开关",
    ...
    },
    {
      ...
      items: [
        S(
          ...
          "配送",
          "多目标点物料配送，自动规划最优路径",
          "Multi-stop material delivery with automatic optimal routing",
        ),
        S(
          "Cruise Mode",
          "巡航",
          "沿预设路径循环运行，逗留点取放物料",
          "Loops along preset routes, pickup/drop-off at stops",
        ),
        S(
          "Lifting Mode",
          "顶升",
          "自动取货、顶起货架运送、自动卸下（仅 WTIDL1）",
          "Auto pick, lift and transport racks, auto drop (WTIDL1 only)",
        ),
        S(
          "Towing Mode",
          "牵引",
          "搭配牵引装置，自动适配被牵引物轮廓（需加装牵引机构）",
          "Works with towing kit, auto-adapts to towed-object profile (towing kit required)",
        ),
        S(
          "Following Mode",
          "跟随",
          "基于前视RGB相机与激光雷达跟随工作人员",
          "Follows staff via front RGB camera and LiDAR",
        ),
        S(
          "Roller Mode",
          "辊筒",
          "搭配辊筒组件对接辊筒线/智能仓储系统（需加装辊筒机构）",
          "Docks with roller conveyors/smart warehouse systems via roller kit (roller kit required)",
        ),
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        S(
          "Expansion Interface",
          "扩展接口",
          "USB 2.0、IO、SIM卡槽（nano）、OTG调试",
          "USB 2.0, IO, SIM slot (nano), OTG debug",
        ),
      ],
    },
    {
