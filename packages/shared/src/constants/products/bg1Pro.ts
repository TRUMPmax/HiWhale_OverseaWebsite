...
export const bg1Pro: MockProduct = {
  ...
  quickSpecs: [
    S("Net Weight", "整机重量", "约 344 kg"),
    S("Clean/Waste Water Tanks", "清水/污水箱", "75L / 60L"),
    S("Runtime", "续航时间", "扫洗一体最大 7.5 h"),
    S("Cleaning Width", "清洁宽度", "550 mm（洗）/ 708 mm（含边刷）"),
  ],
  specGroups: [
    {
      group: L("General", "通用"),
      items: [
        S("Model", "产品型号", "BGBC02"),
        S("Net Weight", "整机重量", "约 344 kg（758 lbs，空载、水箱无水）"),
        S("Dimensions", "整机尺寸", "1195×760×1303 mm（含吸水扒）/ 1120×660×1303 mm（不含吸水扒）"),
    ...
    },
    {
      ...
      items: [
        ...
        S("Cleaning Modes", "清洁模式", "洗地、扫地、吸尘、尘推、抛光"),
        S("Cleaning Efficiency", "清洁效率", "覆盖模式 2000 m²/h；巡检模式 6000 m²/h"),
        S("Travel Speed", "运行速度", "0.2~1.0 m/s（可调节）"),
        S("Max Obstacle Height", "最大越障高度", "25 mm"),
        S("Min Passage Width", "最小通过宽度", "850 mm"),
        S("Max Slope Angle", "最大爬坡角度", "清洁任务时 5°，非清洁任务 8°"),
      ],
    },
    {
      group: L("Battery", "电池"),
      items: [
        S("Battery Capacity", "电池容量", "90 Ah（48V平台）"),
        S("Battery Type", "电池类型", "磷酸铁锂"),
        S("Charging Time", "充电时间", "高压地区（AC≥180V）约 3h；低压地区（AC≤180V）约 4.5h"),
    ...
    },
    {
      ...
      items: [
        ...
        S("Detergent Tank Capacity", "清洁药剂仓容量", "7 L（双仓）"),
    ...
    },
    {
      ...
      items: [
        S("Navigation", "导航方式", "3D Lidar + 3D VSLAM 多传感器融合定位 + AI"),
        S("Auto Parking Brake", "自动驻车", "支持，轮毂内置制动器"),
      ],
    },
    {
      group: L("Safety", "安全"),
      items: [
        ...
        S("Emergency Stop Button", "急停按钮", "双侧配置"),
      ],
    },
    {
      group: L("Communication", "通信"),
      items: [
        S("Connectivity", "通信网络", "支持 4G、Wi-Fi、蓝牙通信、E-gate/Elevator 通信（选装）"),
    ...
    },
    {
      ...
      items: [
        S("Operating Environment", "工作环境", "温度 0~40℃；湿度 ≤90% RH"),
        S("Storage Environment", "储存环境", "温度 -20~70℃；湿度 ≤90% RH"),
        S("Operating Altitude", "工作海拔", "< 2500 m"),
        S("Cleaning Noise", "清洁作业噪音", "约 75 dB(A)"),
      ],
    },
  ],
  features: [
