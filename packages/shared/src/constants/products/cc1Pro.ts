...
export const cc1Pro: MockProduct = {
  ...
  quickSpecs: [
    ...
    S(
      "Runtime",
      "续航时间",
      "洗地 5h / 巡检清洁 1500-3000 m²/h",
      "Scrubbing 5h / patrol cleaning 1,500–3,000 m²/h",
    ),
    S("Cleaning Width", "清洁宽度", "500 mm（含边刷）", "500 mm (incl. side brush)"),
    S("Navigation", "导航方式", "激光 + Marker + VSLAM", "Laser + Marker + VSLAM"),
  ],
  specGroups: [
    {
      group: L("General", "通用"),
    ...
    },
    {
      ...
      items: [
        ...
        S(
          ...
          "前视AI相机",
          "识别地面污渍（咖啡、酱料、积水等）",
          "Detects floor stains (coffee, sauces, standing water)",
        ),
        S(
          "Rear AI Camera",
          "后视AI相机",
          "清洁效果检测 + 二次污染监测",
          "Cleaning-quality inspection + re-contamination monitoring",
        ),
        S(
          "AI Patrol Cleaning",
          "AI巡检清洁",
          "实时识别脏污自动生成最优路径",
          "Real-time dirt detection with automatic optimal path planning",
        ),
        S(
          "AI Adaptive Cleaning",
          "AI自适应清洁",
          "自动切换强力/低功耗模式",
          "Auto-switch between power and eco modes",
        ),
        S("AI Debris/Obstacle Recognition", "AI垃圾/障碍物识别", "支持", "Supported"),
      ],
    },
    {
      group: L("Safety", "安全"),
      items: [
        ...
        S(
          "360° All-round Safety Perception",
          "360° 全方位安全感知",
          "AI融合感知系统",
          "AI fusion perception system",
        ),
