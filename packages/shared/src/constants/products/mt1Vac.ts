...
export const mt1Vac: MockProduct = {
  ...
  quickSpecs: [
    S("Net Weight", "整机重量", "约 75 kg", "Approx. 75 kg"),
    S("Runtime", "续航时间", "3 ~ 6.5 h"),
    S(
      "Cleaning Functions",
      "清洁能力",
      "扫地 + 吸尘 + 尘推三合一",
      "Sweep + vacuum + dust-mop 3-in-1",
    ),
    S("Operating Noise", "工作噪音", "降噪模式 < 65 dB(A)", "Quiet mode < 65 dB(A)"),
  ],
  specGroups: [
    {
      group: L("General", "通用"),
    ...
    },
    {
      ...
      items: [
        S(
          ...
          "清洁能力",
          "纸片碎屑、木屑、灰尘等垃圾",
          "Paper scraps, wood chips, dust and debris",
        ),
        S(
          "Cleaning Method",
          "清洁方式",
          "扫地、吸尘、尘推三合一",
          "Sweeping, vacuuming, dust mopping 3-in-1",
        ),
    ...
    },
    {
      ...
      items: [
        ...
        S("Charging Time", "充电时间", "约 3.5 h", "Approx. 3.5 h"),
        S("Runtime", "续航时间", "3 ~ 6.5 h"),
        S(
          "Auto-Charging",
          "自动充电",
    ...
    },
    {
      ...
      items: [
        S(
          ...
          "尘袋容量",
          "14 L（7 L × 2，不可水洗）",
          "14 L (7 L × 2, non-washable)",
        ),
        S("Waste Bin Capacity", "垃圾盒容量", "6 L"),
        S("HEPA Filtration", "HEPA过滤", "标配（不可水洗）", "Standard (non-washable)"),
      ],
    },
    {
      ...
      items: [
        ...
        S("RGBD Depth Camera", "RGBD深度相机", "2 组", "2 sets"),
        S("RGB Camera", "RGB相机", "2 个", "2"),
    ...
    },
    {
      ...
      items: [
        S(
          ...
          "工作环境",
          "温度 -10℃ ~ 40℃；湿度 ≤ 90% RH",
          "Temperature -10–40 °C; humidity ≤90% RH",
        ),
        S(
