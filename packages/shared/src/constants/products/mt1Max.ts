...
export const mt1Max: MockProduct = {
  ...
  quickSpecs: [
    S("Net Weight", "整机重量", "约 85 kg", "Approx. 85 kg"),
    ...
    S(
      ...
      "防护等级",
      "IP54（-10℃~45℃ 宽温工作）",
      "IP54 (-10 °C to 45 °C wide-temperature operation)",
    ),
  ],
  specGroups: [
    {
    ...
    },
    {
      ...
      items: [
        ...
        S(
          "Max Obstacle Height",
          "最大越障高度",
          "20 mm；可通过 50 mm 以下常见汽车减速带",
          "20 mm; crosses common 50 mm speed bumps",
        ),
    ...
    },
    {
      ...
      items: [
        ...
        S("3D LiDAR", "3D激光雷达", "1 个（顶部）", "1 (top-mounted)"),
        S("VSLAM Camera", "VSLAM相机", "1 个", "1"),
        S("RGBD Depth Camera", "RGBD深度相机", "3 组", "3 sets"),
        S("RGB Camera", "RGB相机", "2 个", "2"),
        S("Water Drop Sensor", "水滴传感器", "1 个", "1"),
