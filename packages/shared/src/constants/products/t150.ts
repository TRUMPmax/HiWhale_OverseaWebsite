  ...
  specGroups: [
    {
      group: L("General", "通用"),
      items: [
        S("Model", "产品型号", "标准版 WTID00 / 顶升版 WTIDL0"),
        S("Net Weight", "整机重量", "标准版 65 kg / 顶升版 81 kg"),
    ...
    },
    {
      ...
      items: [
        S("Max Payload", "最大载重", "150 kg"),
        S("Lift Height", "顶升高度", "60 mm（仅顶升版 WTIDL0）"),
        ...
        S("Runtime", "续航时间", "12 h（空载巡航）/ 8 h（最大负载）"),
      ],
    },
    {
      group: L("Battery", "电池"),
    ...
    },
    {
      ...
      items: [
        S("Navigation", "导航方式", "VSLAM + 激光雷达融合导航"),
        S("RGBD Depth Camera", "RGBD深度相机", "2 个（上、下双向探测）"),
        S("LiDAR", "激光雷达", "2 个（底盘对角布置，360°覆盖）"),
        S("Top Camera", "顶视相机", "1 个（VSLAM建图与天花板定位码识别）"),
        S("Front Camera", "前视相机", "1 个（人体轮廓识别）"),
    ...
    },
    {
      group: L("Safety", "安全"),
      items: [
        S("Safety Standard", "安全标准", "ISO 3691-4；工业配送机器人 CE 认证"),
    ...
    },
    {
      ...
      items: [
        ...
        S("IoT Capabilities", "IoT能力", "自主乘梯、自主闸机通行、按键器远程呼叫、PUDULink APP"),
        ...
        S("Multi-Robot Scheduling", "多机调度", "支持多机自组网调度，无需本地服务器"),
      ],
    },
    {
